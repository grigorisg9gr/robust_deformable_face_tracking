...
S3_DL='3_dlib_pred'
S4_AAM='4_fit_pbaam_new'
S5_SVM='5_svm_faces_new'
S6_AAM='6_fit_pbaam'
...
#  $PYTHON_P visualisations_to_videos.py $PATH1 
  ...
  /vol/atlas/homes/grigoris/installation_folder/miniconda/envs/menpo/bin/python visualise_landmarks.py $S1_DL $S4_AAM $S5_SVM
  echo 'finished'
